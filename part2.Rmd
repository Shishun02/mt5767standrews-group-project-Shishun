...
```
question b\newline
Rainfall affects grassland growth and resource availability, and these factors may directly affect population reproduction and growth. Therefore, the function of rainfall as Rt is more consistent with the logic that resources directly affect population growth in the current year.\newline

question c\newline
Carrying capacity Kt as an upper limit for resource availability may also be directly affected by current rainfall Rt. Rainfall may directly determine the productivity of grassland, so the function of Rt will be more direct.
